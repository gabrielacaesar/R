...
setwd("~/Downloads/")
votacao_nova_dbf <- read.dbf("CD190193.dbf")
...
id_politicos <- read.csv("plenario2019_CD_politicos_9jul2019.csv", encoding = "UTF-8", stringsAsFactors = F)
...
votacao_final$id_proposicao <- "13"

#16. inserir coluna com o nome da proposição

votacao_final$proposicao <- "PEC6-2019-1t"

#17. inserir coluna com o permalink da proposição

votacao_final$permalink <- "pec-da-reforma-da-previdencia-1-turno"

...
twitter_token <- create_token(
  app = "xlsxlsxls",
  consumer_key = "N9BF39I5Z8eVMZivQ5ReGbkhK",
  consumer_secret = "B8JU20x3TGVAcK0AQPRw1ncIshsU3fWRbyvONHVktUb9procjO",
  access_token = "2551415983-rjHszuafAQFINXrCHcUYdzfylzJQIh4et12pmT6",
  access_secret = "4Lx7TjToXCixqqglkAN1UjAh9hQcGm2zKXuSDy5ve4p8w"
)

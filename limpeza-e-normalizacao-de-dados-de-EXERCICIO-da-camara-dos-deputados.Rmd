---
title: "Limpeza e normalização de dados de exercício na Câmara"
description: "Deputados federais em exercício ou fora de exercício"
author:
...
Importamos o arquivo atualizado da Câmara e eliminamos as colunas desnecessárias.
...
Importamos o nosso arquivo base que tem todos os deputados cadastrados e os respectivos IDs. Criamos a coluna com nomes sem acentos e em caps.
...
Dar um merge e checar os partidos e mostrar qual caso houve mudança de sigla.
...
Mostrar quais deputados passam a constar "sim", mas antes estavam como "nao". 
Criar coluna para "Em exercício?". Incluir "sim" quando for positivo e "nao" quando for negativo.
Ajustar colunas para empilhar DFs e ordenar de forma alfabética.
...
Fazer o download do CSV e do XLSX.
...
Mostrar apenas as linhas que devem sofrer mudanças.

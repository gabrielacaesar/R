...
## Importar e verificar o arquivo
...
Desta vez, optamos por não informar se queremos ou não manter as colunas "DIA", "MES" e "ANO", então o que vale é o padrão. Por padrão, o "remove = TRUE". Isso é sempre claro na documentação do R. Você pode digitar no console `?unite` ou pesquisar no site [www.rdocumentation.org](www.rdocumentation.org).
